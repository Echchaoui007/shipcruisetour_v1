    ...
    <div class="col-md-6 mx-auto">
       ...
       <!-- name -->
          <div class="form-group">
            ...
            <?php echo (!empty($data['name_err']))? ' is-invalid' : '';?>"
             ...
             <span class="invalid_feedback"><?php echo $data['name_err']; ?></span>
          </div>
          <!-- email -->
      <div class="form-group">
        ...
        <?php echo (!empty($data['email_err']))? ' is-invalid' : '';?>"
         ...
         <span class="invalid_feedback"><?php echo $data['email_err']; ?></span>
      </div>
      <!-- password -->
      ...
      <div class="form-group">
        ...
        <?php echo (!empty($data['password_err']))? ' is-invalid' : '';?>"
         ...
         <span class="invalid_feedback"><?php echo $data['password_err']; ?></span>
      </div>
      <!-- confirm_password -->
      <div class="form-group">
        ...
        <?php echo (!empty($data['confirm_password_err']))? ' is-invalid' : '';?>"
         ...
         <span class="invalid_feedback"><?php echo $data['confirm_password_err']; ?></span>
      </div>
      <div class="row">
        <div class="col">
